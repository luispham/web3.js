...
var Contract = function Contract(jsonInterface, address, options) {
    ...
    Object.defineProperty(this, "handleRevert", {
        get: function () {
            if (
                _this.options.handleRevert === false ||
                _this.options.handleRevert === true
            ) {
    ...
    Object.defineProperty(this, "transactionConfirmationBlocks", {
        get: function () {
            ...
            return (
                _this.options.transactionConfirmationBlocks ||
...
Contract.prototype._getOrSetDefaultOptions = function getOrSetDefaultOptions(
    ...
    var from = options.from
        ...
        : null;
    var timestamp = options.timestamp ? String(options.timestamp) : null;
    ...
    options.timestamp = timestamp || this.options.timestamp;
    ...
    var signature = false,
        paramsABI =
            this._parent.options.jsonInterface
                ...
                .map(function (json) {
                    var inputLength = _.isArray(json.inputs)
                        ? json.inputs.length
                        : 0;
 ...
 * @param {Promise} defer
 */
Contract.prototype._processExecuteArguments = function _processExecuteArguments(
    args,
    defer
) {
    var processedArgs = {};
        ...
        case "send":
                            ...
                            return _this._parent._decodeEventABI.call(
                                {
                                    name: "ALLEVENTS",
                                    jsonInterface:
                                        _this._parent.options.jsonInterface,
                                },
                                log
                            );
                        });
                        ...
                        events.forEach(function (ev) {
                            if (ev.event) {
                                ...
                                if (receipt.events[ev.event]) {
                                    if (
                                        Array.isArray(receipt.events[ev.event])
                                    ) {
            ...
            var sendTransaction = new Method({
                ...
                transactionConfirmationBlocks:
                    _this._parent.transactionConfirmationBlocks,
                transactionPollingTimeout:
                    _this._parent.transactionPollingTimeout,
