...
Method.prototype._confirmTransaction = function (defer, result, payload) {
                    ...
                    .then(async function (receipt) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                var latestBlock = await _ethereumCall.getBlockByNumber(
                                    "latest"
                                );
                                                ...
                                                txReplayOptions = formatters.inputTransactionFormatter(
                                                    {
                                                        ...
                                                        timestamp: parsedTx.timestamp.toHexString(),
                                                    }
                                                );
                                            }
    ...
    var startWatching = function (existingReceipt) {
        ...
        if (!this.requestManager.provider.on) {
            ...
            _ethereumCall.subscribe("newBlockHeaders", function (
                err,
                blockHeader,
                sub
            ) {
                ...
                if (payload.method === "eth_sendTransaction") {
                    ...
                    if (wallet && wallet.privateKey) {
                        ...
                        return method.accounts
                            .signTransaction(txOptions, wallet.privateKey)
                            .then(sendSignedTx)
                            .catch(function (err) {
                                if (
                                    _.isFunction(
                                        defer.eventEmitter.listeners
                                    ) &&
